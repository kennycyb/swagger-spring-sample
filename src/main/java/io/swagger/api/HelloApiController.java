...
public class HelloApiController implements HelloApi {
    ...
    public ResponseEntity<String> helloUserGet(@ApiParam(value = "The name of the user to greet.",required=true) @PathVariable("user") String user) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            //return new ResponseEntity<String>(objectMapper.readValue("\"{\"hello\":\"world\"} \"", String.class), HttpStatus.OK);
